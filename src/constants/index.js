...
export const ABOUT_TEXT = `I am a Software Developer with 1 year and 8 months of professional experience, specializing in backend development using Python, Django, and FastAPI, along with frontend technologies like React.js and Tailwind CSS. I’ve contributed to diverse projects across AI, Warehouse Management Systems (WMS), and automation, delivering scalable and efficient solutions.

My expertise includes integrating machine learning models into production systems, building intelligent chatbots using Retrieval-Augmented Generation (RAG), and developing agentic AI applications. I'm deeply passionate about AI and continuously explore innovative ways to apply it in solving real-world problems.`;
...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    technologies: ["Python", "FastAPI", "AI", "Gen AI", "LLM's"],
  },
];
...
export const PROJECTS = [
  {
    ...
    technologies: ["HTML", "CSS", "JavaScript", "React", "Tailwind CSS", "Python", "Django", "ML", "AI", "Gen AI"],
  },
  {
    title: "Medozai",
    description:
    ...
    technologies: ["Python", "Streamlit", "LLMs", "WebRTC", "Gen AI", "AI", "FAST API"],
  },
  {
  ...
  },
  {
    ...
    technologies: ["Python", "Streamlit", "Gen AI", "LLMs", "Speech Processing"],
  },
  {
