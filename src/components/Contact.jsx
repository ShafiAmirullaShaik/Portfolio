  ...
  return (
    <div className="border-b border-neutral-900 pb-20">
      ...
      >
        ...
        <a href="https://github.com/ShafiAmirullaShaik" className={`border-b ${!isLight ? 'border-blue-400 font-thin text-blue-400' : 'border-blue-600 font-light text-blue-600'
        } `}>
